...
@app.route('/')
def serve_index():
    """Serve customer order form (if any)"""
...
def create_new_order():
    ...
    try:
        ...
        # This return must be present (handles any unexpected exception)
...
if __name__ == '__main__':
    ...
    print(f"   • Admin Token: {ADMIN_TOKEN[:10]}... (hidden)")
    print(f"\n📍 Access:")
    print(f"   • Customer Page: http://localhost:5000 (if run locally)")
